...
(6, '0006', 'กรุณาส่งรูปใบส่งตัวที่กรอกรายละเอียดชัดเจน โดยเฉพาะตำแหน่งที่ 1, 2, 3 ตามตัวอย่างรูปด้านล่าง ', 1, '0007', NULL, NULL),

(7, '0007', 'ท่านส่งรูปใบส่งตัวที่ชัดเจนเรียบร้อยแล้วใช่หรือไม่', NULL, 1, '0008', NULL, NULL),

(8, '0008', 'ผู้ป่วยใช้สิทธิการรักษาเป็นประกันสังคมหรือไม่', 1, '0009', NULL, NULL),
...
(10, '0010', 'ท่านส่งรูปใบส่งตัวประกันสังคมชัดเจนเรียบร้อยแล้วใช่หรือไม่', 1, '0011', NULL, NULL),
...
(12, '0012', 'ท่านส่งรูปเอกสารหมายเลข 1 ที่ชัดเจนเรียบร้อยแล้วใช่หรือไม่', 1, '0013', NULL, NULL),

(13, '0013', 'ท่านส่งรูปเอกสารหมายเลข 1 ที่ชัดเจนเรียบร้อยแล้วใช่หรือไม่', NULL, 1, '0014', NULL, NULL),

(14, '0014', 'กรุณาส่งรูปบัตรประจำตัวประชาชนของผู้ป่วยที่ชัดเจนตามรูปตัวอย่างด้านล่างนี้', 1, '0015', NULL, NULL),
...
(18, '0018', 'ท่านส่งรูปใบกรอกประวัติผู้ป่วยใหม่ที่ชัดเจนเรียบร้อยแล้วใช่หรือไม่', 1, '0019', NULL, NULL),
